...
<<baseline-regs-coefficient-table, cache = T, include = T, results = 'asis'>>=
# Put all of the models in a list

simple_models_log<-list(log_ecsit, 
                        log_unem, 
                        log_pconf, 
                        log_aprov, 
                        log_polscore)
...
modelsummary(simple_models_log,
...
<<difgraph, cache = T, include = T, fig.align='center', fig.width= 10, fig.height= 10>>=
