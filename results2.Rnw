...
<<baseline-regs-coefficient-table, include = T, results = 'asis'>>=
...
<<baseline-aoes-table, include = T, results = 'asis'>>=
# Coefficient mappings

coefficient_names_apes<-c('gndrWoman' = 'Woman',
                          'year2016' = '2016 Dummy',
...
modelsummary(base_models_log,
             stars = c('*'= 0.1, '**' = 0.05, '***'= 0.01),
             output = 'latex_tabular',
             coef_map = coefficient_names_apes,
