...
political_graph_df<-
  ...
  mutate(legend = 'Percent of voting-age citizens who confide in the President') %>% 
  filter(year != 2004, 
         year != 2006)
...
japrov_df_g<-
  ...
  mutate(legend = 'Percent of voting-age citizens who approve the President\'s job performance')

# 

# Now unite all of these.
