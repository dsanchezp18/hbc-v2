...
% Perform survey-weighted calculations to be used in this document and in other children of the main by sourcing the tabulations script. 

<<tabulations-intro>>=
# New corruption perceptions question tab.
...
# Corruption tolerance (%) time series
...
# Job Approval percentage time series
