...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(corrper\_time, aes(x = year, y = corrper, group = corrper)): object 'corrper\_time' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'corrper\_g' not found}}\end{kframe}
\end{knitrout}
