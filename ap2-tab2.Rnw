...
<<table-probit-lpm, cache = T, include = T, results = 'asis', warning = F, message = F>>=
# Source the models
...
prob_baseline_regs<-list(prob_ecsit, 
                         prob_unem, 
                         prob_pconf, 
                         prob_aprov, 
                         prob_polscore)

# Get the gof mappings
...
modelsummary(prob_baseline_regs,
